...
def main():
    ...
    for name in specials:
        lines_h.append(f"    OP_{name} = {op},")
        op += 1
    lines_h += ["    OP_GLES_LAST", "};", ""]
    reply_ops = [
        "glCheckFramebufferStatus", "glCopyTexImage2D", "glCopyTexSubImage2D",
        "glGenerateMipmap", "glBlitFramebuffer", "glFramebufferTexture2D",
        "glTexImage2D", "glCompressedTexImage2D", "glCreateProgram",
        "glCreateShader", "glFinish", "glGetError", "glIsBuffer", "glIsEnabled",
        "glIsFramebuffer", "glIsProgram", "glIsRenderbuffer", "glIsShader",
        "glIsTexture", "glGenBuffers", "glGenFramebuffers", "glGenRenderbuffers",
        "glGenTextures", "glGenVertexArrays", "glGetString", "glGetIntegerv",
        "glGetFloatv", "glGetBooleanv", "glGetShaderiv", "glGetProgramiv",
        "glGetShaderInfoLog", "glGetProgramInfoLog", "glGetAttribLocation",
        "glGetUniformLocation", "glReadPixels", "glGetBufferParameteriv",
        "glMapBufferOES", "glUnmapBufferOES", "glGetBufferPointervOES",
        "glMapBufferRange", "glGetActiveAttrib", "glGetActiveUniform",
        "glGetAttachedShaders", "glGetFramebufferAttachmentParameteriv",
        "glGetRenderbufferParameteriv", "glGetShaderPrecisionFormat",
        "glGetShaderSource", "glGetTexParameterfv", "glGetTexParameteriv",
        "glGetUniformfv", "glGetUniformiv", "glGetVertexAttribfv",
        "glGetVertexAttribiv", "glIsVertexArray",
    ]
    lines_h += [
        "static inline int tspgl_needs_reply(uint32_t op)",
        "{", "    if (op < 16)", "        return 1;", "    switch (op) {",
    ]
    lines_h += [f"    case OP_{name}:" for name in reply_ops]
    lines_h += [
